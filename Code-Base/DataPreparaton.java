...
public class DataPreparaton {
	...
	public static void main(String args[]) throws FileNotFoundException,
			IOException {
		String FILE_LOCATION = "home/vagisha/data";
		// Number of maximum instances of each attack
		int noOfAttack = 250;
		int noOfNormal = 3000;
		// Filepath for built datasets
		String anomaly = "/home/vagisha/data/Dataset_Anomaly.csv";
		String misuse = "/home/vagisha/data/Dataset_Misuse.csv";
		// Filepath for Input files
		String attackPath = "/home/vagisha/data/Optimized_";
